...
from paper.datasets import build_dataset
from paper.models import build_model
from mmedit.utils import collect_env, setup_multi_processes
...
def main():
    ...
    logger = get_logger(name="HandlerOne", log_file=log_file, log_level=cfg.log_level)
